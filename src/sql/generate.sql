...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Organization` (`id`, `Name`, `Creating date`, `Description`, `Adress`, `Creator_Id`) VALUES (1, 'Funny posts', '11-11-2002', 'hehehehehehh', 'kyiv', 1);
INSERT INTO `mydb`.`Organization` (`id`, `Name`, `Creating date`, `Description`, `Adress`, `Creator_Id`) VALUES (2, 'Study tests', '12-11-2019', 'bad bad university', 'rivne', 2);
INSERT INTO `mydb`.`Organization` (`id`, `Name`, `Creating date`, `Description`, `Adress`, `Creator_Id`) VALUES (3, 'Angels only', '12-12-2020', 'TY NE ANGEL', 'heaven', 5);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`BlacklistedUser` (`User_Id`, `Organization_id`) VALUES (4, 1);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`WhitelistedUser` (`User_Id`, `Organization_id`) VALUES (5, 3);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Poll` (`id`, `Title`, `Description`, `Creation date`, `End date`, `IsPrivate`, `Link`, `Creator_Id`, `Organization_id`, `PollType_Id`) VALUES (1, 'Which OT teacher are you?', 'just for fun', '12-12-2020', '01-01-2021', 0, 'funny', 1, 1, 1);
INSERT INTO `mydb`.`Poll` (`id`, `Title`, `Description`, `Creation date`, `End date`, `IsPrivate`, `Link`, `Creator_Id`, `Organization_id`, `PollType_Id`) VALUES (2, 'Final exam', 'I WILL KILL YOU FOR THE WRONG ANSWERS!', '12-12-2021', '12-12-2021', 1, 'test', 2, 2, 3);
